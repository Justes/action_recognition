...
from models.video_model import VideoTransformer
from dataloaders.data_trainer import DataModule
...
def parse_args():
	...
	parser.add_argument(
		"-source_names", default="ucf101", type=str,
		help="dataset name")
	parser.add_argument(
		"-root", default="../datasets", type=str,
		help="dataset name")
...
def single_run():
	...
	data_module = DataModule(configs=args,
									 dataset=dataset,
									 frame=frame,
									 root=root)
