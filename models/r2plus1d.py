...
model_urls = {
    "r2plus1d": "../pretrained/r2plus1d-pretrained.pth"
}
...
def r2plus1d_model(num_classes, pretrained=True, **kwargs):
    model = R2Plus1DClassifier(num_classes, (2, 2, 2, 2), pretrained=pretrained)
    if pretrained and kwargs.get("pretrained_model") is not None:
        print(kwargs.get("pretrained_model", model_urls["r2plus1d"]))
